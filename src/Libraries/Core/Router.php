...
final class Router
{
  ...
  public static string $controller_namespace = '\\CarlBennett\\API\\Controllers\\';
  public static string $global_namespace = '\\CarlBennett\\API\\';
  public static string $view_namespace = '\\CarlBennett\\API\\Views\\';
  ...
  protected static function invokeController(\CarlBennett\API\Interfaces\Controller $controller, string $view, ?array $args): void
  {
  ...
  protected static function negotiateView(array $route_views): string
  {
    ...
    foreach ($route_views as $view_class)
    {
      ...
      if (!\class_exists($view_class)) throw new \CarlBennett\API\Exceptions\InvalidViewException($view_class);
