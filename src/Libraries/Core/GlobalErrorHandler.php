...
class GlobalErrorHandler
{
  ...
  {
    \set_error_handler('\\CarlBennett\\API\\Libraries\\Core\\GlobalErrorHandler::errorHandler', E_ALL);
    \set_exception_handler('\\CarlBennett\\API\\Libraries\\Core\\GlobalErrorHandler::exceptionHandler');
  }
