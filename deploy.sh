...
rsync -Oprtvz --delete --exclude='.git/' --exclude='.gitignore' --exclude='deploy.sh' --exclude 'README.md' --exclude='settings.sample.json' . root@carlbennett.me:/home/nginx/carlbennett-api
