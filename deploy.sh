...
rsync -Oprtvz --delete --exclude='.git/' --exclude='.gitignore' --exclude='deploy.sh' --exclude 'README.md' --exclude='settings.sample.json' "$DEPLOY_SOURCE" "carl@carlbennett.me:$DEPLOY_TARGET"
